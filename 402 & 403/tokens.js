...
let tokens = ["bitcoin","ethereum","cardano","tether","binancecoin","solana","ripple","polkadot","dogecoin","usd-coin","terra-luna","avalanche-2","chainlink","binance-usd","uniswap","litecoin","bitcoin-cash","algorand","internet-computer","wrapped-bitcoin","ftx-token","cosmos","matic-network","filecoin","vechain","tron","stellar","ethereum-classic","theta-token","dai","compound-ether","elrond-erd-2","tezos","compound-usd-coin","quant-network","okb","eos","crypto-com-chain","pancakeswap-token","cdai","monero","aave","the-graph","staked-ether","iota","near","bitcoin-cash-abc-2","ecash","axie-infinity","kusama","fantom","hedera-hashgraph","neo","klay-token","shiba-inu","waves","bitcoin-cash-sv","leo-token","bittorrent-2","maker","arweave","terrausd","amp-token","huobi-token","celsius-degree-token","thorchain","compound-governance-token","sushi","dash","helium","harmony","havven","decred","huobi-btc","chiliz","holotoken","theta-fuel","nem","iostoken","enjincoin","xdce-crowd-sale","zcash","blockstack","true-usd","zilliqa","qtum","omisego","flow","yearn-finance","basic-attention-token","mdex","ravencoin","bitcoin-gold","decentraland","icon","mina-protocol","osmosis","raydium","telcoin","zencash","paxos-standard","xsushi","audius","siacoin","bancor","curve-dao-token","kucoin-shares","bitclout","nxm","nexo","0x","ontology","digibyte","safemoon","compound-usdt","link","gatechain-token","ankr","nano","ecomi","ergo","olympus","the-sandbox","perpetual-protocol","celo","coin98","renbtc","swissborg","uma","constellation-labs","republic-protocol","dydx","ultra","titanswap","iotex","fetch-ai","loopring","kava","serum","liquity-usd","metahero","polymath","xyo-network","yield-guild-games","1inch","golem","lisk","wazirx","swipe","unibright","neutrino","oxygen","reserve-rights-token","celer-network","pirate-chain","dent","vectorspace","nervos-network","wax","eden","husd","skale","rocket-pool","persistence","alpha-finance","shiden","energy-web-token","anchor-protocol","livepeer","gnosis","mango-markets","wink","fei-protocol","akash-network","pundi-x-2","bitcoin-diamond","trust-wallet-token","medibloc","vethor-token","injective-protocol","verge","bakerytoken","asd","oasis-network","venus","bonfida","seth","status","chia","electroneum","aelf","aurora-dao","origin-protocol","tokamak-network","civic","ocean-protocol","pundi-x","ardor","secret","mask-network","digitalbits","storm","orbs","reef-finance","frax","band-protocol","illuvium","pax-gold","fx-coin","star-atlas","prometeus","truefi","bifrost","lido-dao","plex","allianceblock","iexec-rlc","coti","orion-protocol","tribe-2","mirror-protocol","balancer","conflux-token","velas","cartesi","stratis","alien-worlds","marketpeak","woo-network","numeraire","convex-finance","hive","casper-network","ark","nusd","steem","nkn","dawn-protocol","verasity","star-atlas-dao","keep-network","ellipsis","ton-crystal","alchemix-usd","superfarm","kadena","dodo","funfair","aragon","my-neighbor-alice"]